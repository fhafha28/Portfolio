    ...
    <div class="container-fluid">
        <a class="navbar-brand" href="/">
            <x-icon src="logo.svg" alt="" width="30" height="24"
                    class="d-inline-block align-text-top color-light"></x-icon>
            Larapics
        </a>
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
            ...
            <ul class="navbar-nav ms-auto">
                ...
                @else
{{--                    로그인 한 유저에게 보이는 메뉴들은 이 아래부터 --}}
                    <li class="nav-item"><a href="{{route('images.index')}}"
                                            class="nav-link {{request()->is('account/images*')? 'active' : '' }}">Images</a>
                    </li>
                    <li class="nav-item"><a href="{{route('images.index')}}"
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <div class="dropdown-menu dropdown-menu-end" aria-labelledby="navbarDropdown">
                            <a href="{{route('setting.edit')}}" class="dropdown-item">Settings</a>
