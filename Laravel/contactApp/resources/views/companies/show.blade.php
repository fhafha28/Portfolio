...
@section('title', 'Contact App |  '.$company->name)
@section('show')
    <main class="py-5">
        <div class="container">
...
{{--                                           원래 form태그 생긴거 <form action="{{route('companies.destroy', ['company'=>$company->id, 'redirect'=>'companies.index'])}}"--}}
{{--                                                method="POST" style="display: inline">--}}

                                                @include('shared.buttons.destroy', ['action'=>route('companies.destroy', ['company'=>$company->id, 'redirect'=>'companies.index']),'buttonStyle' => 'default'])
