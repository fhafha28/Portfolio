...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <textarea name="address" id="address" rows="3" class="form-control @error('address') is-invalid @enderror">{{old('address', $contact->address)}}
                @error('address')
                <div class="invalid-feedback">{{$message}}</div>
                @enderror
                </textarea>
        ...
        <div class="form-group row">
            ...
            <div class="col-md-9">
                <select name="company_id" row="3" id="company_id" class="form-control @error('company_id') is-invalid @enderror">
