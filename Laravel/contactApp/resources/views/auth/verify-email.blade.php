                    ...
                    <div class="card">
                        <div class="card-body">
                            @if (session('status') == 'verification-link-sent')
                                <div class="alert alert-success">Verification link has been sent to your e-mail.</div>
                            @endif
                            ...
                            <p class="mb-0">If you didn't recieve the email, we will gladly send you another.</p>
